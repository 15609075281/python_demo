...
def get_url():
    ...
    driver.find_element_by_name("TPL_username").send_keys('输入账号')
    # 找到账号密码框的DOM节点，并且在该节点内输入密码
    driver.find_element_by_name("TPL_password").send_keys('输入密码')
    # 找到账号登录框的提交按钮，并且点击提交
    ...
    for page in range(1, 100):
        ...
        try:
            ...
            for i in range(len(title)):
                ...
                # 使用urllib2进行Request
                request = requests.get(href_value, headers=headers)
                # 访问链接
