...
def is_login():
    ...
    response = session.get("https://www.zhihu.com/", headers=header, allow_redirects=False)
    if response.status_code != 200:
        zhihu_login("+8615609075281", "hc123456789")
    else:
        print("你已经登陆了")
...
def get_log():
    print()
    url='https://www.zhihu.com/question/41088875/answer/90876435'
    responess=requests.get(url,header=header)
